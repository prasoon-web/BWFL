...
public class PendingPermitFL2D_20_21Action {
	...
	public void viewDetails(ActionEvent e) {
		try {
			UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
					.getParent();
			PendingPermitFL2D_20_21DT dt = (PendingPermitFL2D_20_21DT) this.getDisplayRegUsers()
	...
	public void printReport(ActionEvent e) throws ParseException {
		...
		PendingPermitFL2D_20_21DT dt = (PendingPermitFL2D_20_21DT) this.getDisplayRegUsers().get(uiTable.getRowIndex());
